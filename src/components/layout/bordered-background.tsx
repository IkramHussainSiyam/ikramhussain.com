...
export default function BorderedBackground() {
  return (
    <>
      <div className="opacity-0 sm:opacity-100 pointer-events-none bg-none w-[150px] min-h-screen border-x border-border/15 fixed position-screen-center -z-[9999]"></div>{" "}
